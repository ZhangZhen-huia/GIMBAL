...
void buzzer_effects_task(void const *argument)
{
	...
	buzzer_control.sound_effect = D_D_D_;
	...
	for (;;)
	{
		...
		if (buzzer_control.work == TRUE)
		{
			...
			case SYSTEM_START_BEEP:
				buzzer_control.sound_effect = STOP;
				buzzer_is_busy = TRUE;
				buzzer_on(3, 10000);	osDelay(333);
				buzzer_on(2, 10000);	osDelay(333);
				buzzer_on(1, 10000);	osDelay(333);
				buzzer_off();
				buzzer_is_busy = FALSE;
				break;
			...
			case D_B_B_:
				buzzer_control.sound_effect = STOP;
				buzzer_is_busy = TRUE;
				buzzer_on(4, 5000);	osDelay(70);
				buzzer_off();			osDelay(70);
				buzzer_on(1, 5000);	osDelay(70);
				buzzer_off();			osDelay(70);
				buzzer_on(1, 5000);	osDelay(70);
				buzzer_off();
				buzzer_is_busy = FALSE;
